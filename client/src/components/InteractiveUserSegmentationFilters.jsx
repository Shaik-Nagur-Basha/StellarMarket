...
function InteractiveUserSegmentationFilters() {
  ...
  return (
    <div className="min-h-screen bg-gray-100 pt-20 pb-10 px-4">
      <div className="max-w-md mx-auto bg-white rounded-lg shadow-xl p-6">
        <h1 className="text-3xl font-bold mb-6 text-center">Interactive User Segmentation</h1>
        <div className="mb-4">
          <select
            value={filter}
...
export default InteractiveUserSegmentationFilters;
