...
function LiveDataAnalyticsIntegration() {
  ...
  return (
    <section className="py-12 bg-white">
      <div className="max-w-3xl mx-auto px-4">
        <h2 className="text-3xl font-bold text-center mb-8">Live Data Analytics</h2>
        {data.length === 0 ? (
...
export default LiveDataAnalyticsIntegration;
